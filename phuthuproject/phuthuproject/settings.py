"""
Django settings for phuthuproject project.
...
SECRET_KEY = '_8v&wu+zi(7ae@f^ue+i4m7!_#wbtz$+g8&zt!h6q#y0e)mu_%'
...
ROOT_URLCONF = 'phuthuproject.urls'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR,'live-static','static-root') # chu y load css

STATICFILES_DIRS=(
                  os.path.join(BASE_DIR,'static','static-root'),
